...
// 探针xyz的偏移
#define MY_X_PROBE_OFFSET_FROM_EXTRUDER -1//0
#define MY_Y_PROBE_OFFSET_FROM_EXTRUDER 16//14.0
#define MY_Z_PROBE_OFFSET_FROM_EXTRUDER -4.5 //-2.6
...
#define MY_MANUAL_Z_HOME_POS 290//179.5//180.3
